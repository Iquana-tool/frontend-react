      ...
      <div className="min-h-screen backdrop-blur-3xl px-6 py-12">
        <div className="container mx-auto max-w-7xl">
          <header className="mb-16 text-center">
            <h1 className="text-6xl font-black mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-500">
              Coral Segmentation
            </h1>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 rounded-2xl p-6 backdrop-blur-md border border-gray-700/50 shadow-2xl">
                {isLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-16 text-gray-400">
                    <Activity className="w-16 h-16 mb-4 text-blue-500/60" />
          ...
          <footer className="mt-16 text-center text-gray-400 border-t border-gray-800 pt-8">
            ...
            <p className="text-sm text-gray-500">
              Segmentation by artificial intelligence
            </p>
          </footer>
        </div>
      </div>
