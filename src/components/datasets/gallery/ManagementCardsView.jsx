...
const ManagementCardsView = ({
  ...
  const cards = [
    ...
    },
    {
      ...
      group: 'data',
      icon: Download,
      title: 'Export IQUANA ZIP',
      description: 'Download the complete dataset in native IQUANA archive format (.zip) for backup or transfer',
      onClick: onExportIquanaClick,
      permitted: can(Permission.EXPORT_ANNOTATIONS) && can(Permission.EXPORT_IMAGES),
      color: 'amber',
    },
    {
      id: 'manage-access',
