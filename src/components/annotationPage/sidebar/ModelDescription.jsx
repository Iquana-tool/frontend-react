...
const ModelDescription = ({ model, modelType }) => {
  const descriptions = {
    ...
    // Completion models
    dino_1000_cosine_he_max_agg: "A dual encoder-decoder architecture using DINO v3 backbone with an image size of 1000 px. The decoder uses cosine similarity with maximum similarity aggregation and histogram equalization to find similar objects.",
