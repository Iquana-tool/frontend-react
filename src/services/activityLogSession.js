 ...
 *
 * Deliberately its own module. Both the activity log client and the API layer need
 * the current id -- the client to stamp events it buffers, the API layer to put
 * it on the `X-Activity-Session` header so backend-emitted events join the same
 ...
 */
const STORAGE_KEY = 'activity_log_session_id';
